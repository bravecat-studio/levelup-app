...
|-----------|------|------------------|-----------|
| **적응형 배너 (Adaptive Banner)** | 안정적 기본 수익 | 25~30% | 던전 탭 진입 시 하단 상시 노출 |
...
| **네이티브 고급형 (Native Advanced)** | 피드 내 자연스러운 광고 | 10~15% | 소셜탭 랭킹 5번째 + Day1탭 피드 3번째 위치 |
...
|-----------|-------------|-----------|---------------|
| **적응형 배너** | `ca-app-pub-6654057059754695/2995161826` | 던전 탭 하단 고정 | 상시 (던전 탭 진입 시) |
...
| **네이티브 고급형** | `ca-app-pub-6654057059754695/8612252339` | 소셜 탭 랭킹 5번째 위치, Day1 탭 피드 3번째 위치 | 탭당 1회 |

> ⚠️ **참고:** 일반 전면 광고(Interstitial)는 현재 미적용 상태. 보상형 전면이 전면 광고 역할을 대체.

### 10.2 수익 시뮬레이션

| MAU | 배너 | 보상형 비디오 | 보상형 전면 | 네이티브 | **월 총 수익** | Firebase 비용 | **순수익** |
|-----|------|--------------|------------|---------|----------------|---------------|------------|
| 1,000 | $2 | $3 | $1 | $1 | **~$7** | $0 | **+$7** |
| 5,000 | $10 | $16 | $7 | $7 | **~$40** | ~$2 | **+$38** |
| 10,000 | $22 | $36 | $17 | $15 | **~$90** | ~$6 | **+$84** |
| 30,000 | $72 | $116 | $55 | $47 | **~$290** | ~$20 | **+$270** |
| 50,000 | $120 | $200 | $95 | $75 | **~$490** | ~$35 | **+$455** |
| 100,000 | $245 | $400 | $195 | $160 | **~$1,000** | ~$65 | **+$935** |
...
| **Phase 2** | 광고 분기 처리 (배너·네이티브·보상형·보상형 전면) | 🔴 높음 | 3시간 |
